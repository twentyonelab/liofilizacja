...
Stan na 2026-09-05: **wersja 0.5 na GitHub Pages: https://twentyonelab.github.io/liofilizacja/** `index.html` + `assets/`. Silnik modelu podłączony do symulatora i do liczb na podstronach. Propozycja architektury: `plan/plan-strony.html`.
...
| `index.html` | **Strona v0.5.** Siedem widoków (Start + 01 Liofilizacja + 02–06), router na hash. Sloty na zdjęcia `assets/img/foto-taca.jpg` i `foto-urzadzenie.jpg` z zastępnikiem, gdy pliku brak. Liczby wstawiane z modelu przez `data-k`. |
...
- **2026-09-05** – wersja 0.5: tabela porównawcza na 01 w formie pricingowej (dwie kolumny, ✓ / ✕ / = kolorem, 11 cech, źródło pod nazwą cechy). Z 03 usunięty blok Agregat (dublował 02) i uwagi projektowe o PCM. „Piśmiennictwo” → „literatura”. **Zdjęcia nadal nie dotarły jako pliki.**
