...
Strona prezentacyjna linii liofilizacji 21 zmysłów × Emix: urządzenie, linia i hala, ekonomia, symulator bilansu, finansowanie, metodyka.
...
| Ścieżka | Rola |
|---|---|
| `index.html` | Cała strona, siedem widoków przełączanych routerem na hash (`#/`, `#/urzadzenie`, `#/linia`, `#/ekonomia`, `#/symulator`, `#/granty`, `#/metodyka`). |
